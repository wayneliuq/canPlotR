...
golem::fill_desc(
  ...
  author_email = "wayneliuq@gmail.com", # Your Email
  repo_url = "https://github.com/wayneliuq/canPlotR" # The URL of the GitHub Repo (optional) 
)     
...
usethis::use_mit_license( "Qiang (Wayne) Liu" )  # You can set another license here
